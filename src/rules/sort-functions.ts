        ...
        return {
            ...
            "Program:exit"(){
                ...
                let functionsArray: Array<[string, IFunctionInfo]> = [...functions],
                    ...
                    indexLastAnyPublicFunc: number  = indexLastPublicFunc > indexLastExportFunc ? indexLastPublicFunc : indexLastExportFunc > 0 ? indexLastExportFunc : -1;
                ...
                for (let len = functionsArray.length - 1, i = len; 0 <= i; i--) {
                    ...
                    if(info.modificator === FuncModificator.PUBLIC && (i < indexLastExportFunc || i > indexLastPrivateFunc)) {
                        context.report({
                            node: info.node,
                            messageId: "incorrectOrder",
                            data: {
